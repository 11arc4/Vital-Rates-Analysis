#How do our correlated results change if we set the yearly variance of
#recruitment to equal that of SY and ASY return?
...
recruitmentParameters <- estBetaParams(mu=nestlingMark$results$real$estimate[1], var=0.0075)
...
png(filename = "~/TAships/Biol 302_ Populaiton Ecology/302 Guest Lecture/Sensitivity Plot_correlated high variance Recruitment.png", 
...
png(filename = "~/TAships/Biol 302_ Populaiton Ecology/302 Guest Lecture/Elasticity Plot_correlated high variance recruitment.png", 
    width=800, height=500)
ElasticityPlot
dev.off()
...
png("~/Masters Thesis Project/Vital Rates Paper/Sensitivity Analysis Plot with correlation and high variance recruitment.png", height=800, width=500)
CorrSensPlot
dev.off()
...
SensitivityAnalysis[order(SensitivityAnalysis$R2_E, decreasing=T),]
