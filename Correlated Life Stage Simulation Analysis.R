...
FemaleSurvival <- read.csv("file:///C:/Users/11arc/Documents/Masters Thesis Project/TRES Data Analysis/Vital Rates Models/RMark Preliminary Survival Analysis/Model Averaged Female Yearly Apparent Survival.csv", as.is=T)
...
for (i in 1:nrow(vrdat)){
  ...
  #Now combine them into what will go into the matrix.
...
png(filename = "~/Masters Thesis Project/Vital Rates Paper/Figures/Correlation Matrix Plot.png", 
