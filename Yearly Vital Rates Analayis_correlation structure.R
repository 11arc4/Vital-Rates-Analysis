...
SensitivityPlot <- ggplot()+
  ...
  geom_point(aes(x=modRecruit$coefficients[2], y=sumRecruit$adj.r.squared), color="darkgreen")+ #Add Recruitment
  annotate("text",x=modRecruit$coefficients[2], y=sumRecruit$adj.r.squared-0.03, label="Recruitment", color="darkgreen", size=6)+
  
  geom_point(aes(x=modASYReturn$coefficients[2], y=sumASY$adj.r.squared), color="darkgreen")+ #add ASY return
  annotate("text", x=modASYReturn$coefficients[2], y=sumASY$adj.r.squared+0.03, label="ASY Return", color="darkgreen", size=6)+
  
  geom_point(aes(x=modSYReturn$coefficients[2], y=sumSY$adj.r.squared), color="darkgreen")+ #add SY return
  annotate("text",x=modSYReturn$coefficients[2], y=sumSY$adj.r.squared-0.03, label="SY Return", color="darkgreen" , size=6)+
  
  geom_point(aes(x=modAverageNestsSY$coefficients[2], y=sumAverageNestsSY$adj.r.squared), color="blue") + #add average nests
  annotate("text",x=modAverageNestsSY$coefficients[2], y=sumAverageNestsSY$adj.r.squared-0.03, label="SY Nest Attempts", color="blue", size=6)+
  geom_point(aes(x=modAverageNestsASY$coefficients[2], y=sumAverageNestsASY$adj.r.squared), color="blue") + #add average nests
  annotate("text",x=modAverageNestsASY$coefficients[2]+0.07, y=sumAverageNestsASY$adj.r.squared-0.05, label="ASY Nest \n Attempts", color="blue" , size=6)+
  
  geom_point(aes(x=modClutchSizeSY$coefficients[2], y=sumClutchSY$adj.r.squared), color="blue")+ #add clutch size
  annotate("text", x=modClutchSizeSY$coefficients[2], y=sumClutchSY$adj.r.squared+0.035, label="SY Clutch Size", color="blue", size=6)+
  
  geom_point(aes(x=modClutchSizeASY$coefficients[2], y=sumClutchASY$adj.r.squared), color="blue")+ #add clutch size
  annotate("text", x=modClutchSizeASY$coefficients[2], y=sumClutchASY$adj.r.squared+0.035, label="ASY Clutch Size", color="blue", size=6)+
  
  geom_point(aes(x=modHatch$coefficients[2], y=sumHatch$adj.r.squared), color="purple")+ #add Hatch size
  annotate("text", x=modHatch$coefficients[2], y=sumHatch$adj.r.squared+0.07, label="Hatch \n Rate", color="purple", size=6)+
  geom_point(aes(x=modFledge$coefficients[2], y=sumFledge$adj.r.squared), color="purple")+ #add fledge rate
  annotate("text",x=modFledge$coefficients[2], y=sumFledge$adj.r.squared-0.03, label="Fledge Rate" , color="purple", size=6)+
...
jpeg(filename = "Sensitivity Plot.jpeg", 
...
ElasticityPlot <- ggplot()+
  xlab("Elasticity")+
  ylab(expression(paste("Adjusted R"^ 2)))+
  geom_point(aes(x=modRecruit_elasticity$coefficients[2], y=sumRecruit_e$adj.r.squared), color="darkgreen")+ #Add Recruitment
  annotate("text",x=modRecruit_elasticity$coefficients[2], y=sumRecruit_e$adj.r.squared-.02, label="Recruitment", color="darkgreen", size=6)+
  
  geom_point(aes(x=modASYReturn_elasticity$coefficients[2], y=sumASY_e$adj.r.squared), color="darkgreen")+ #add ASY return
  annotate("text", x=modASYReturn_elasticity$coefficients[2], y=sumASY_e$adj.r.squared-0.03, label="ASY Return", size=6, color="darkgreen")+
  
  geom_point(aes(x=modSYReturn_elasticity$coefficients[2], y=sumSY_e$adj.r.squared), color="darkgreen")+ #add SY return
  annotate("text",x=modSYReturn_elasticity$coefficients[2], y=sumSY_e$adj.r.squared+0.03, label="SY Return" , size=6, color="darkgreen")+
  
  geom_point(aes(x=modAverageNestsSY_elasticity$coefficients[2], y=sumAverageNestsSY_e$r.squared), color="blue") + #add average nests
  annotate("text",x=modAverageNestsSY_elasticity$coefficients[2], y=sumAverageNestsSY_e$r.squared+.05, label="SY Nest \n Attempts", color="blue", size=6 )+
  
  geom_point(aes(x=modAverageNestsASY_elasticity$coefficients[2], y=sumAverageNestsASY_e$r.squared), color="blue") + #add average nests
  annotate("text",x=modAverageNestsASY_elasticity$coefficients[2]+0.05, y=sumAverageNestsASY_e$r.squared+.05, label="ASY Nest \n Attempts" , color="blue", size=6)+
  
  geom_point(aes(x=modClutchSizeSY_elasticity$coefficients[2], y=sumClutchSY_e$r.squared), color="blue")+ #add clutch size
  annotate("text", x=modClutchSizeSY_elasticity$coefficients[2], y=sumClutchSY_e$r.squared+.03, label="SY Clutch Size", color="blue", size=6)+
  
  geom_point(aes(x=modClutchSizeASY_elasticity$coefficients[2], y=sumClutchASY_e$r.squared), color="blue")+ #add clutch size
  annotate("text", x=modClutchSizeASY_elasticity$coefficients[2]-0.06, y=sumClutchASY_e$r.squared-.03, label="ASY Clutch \n Size", color="blue", size=6)+
  
  geom_point(aes(x=modhatch_elasticity$coefficients[2], y=sumHatch_e$adj.r.squared), color="purple")+ #add Hatch size
  annotate("text", x=modhatch_elasticity$coefficients[2], y=sumHatch_e$adj.r.squared-0.03, label="Hatch Rate", color="purple", size=6)+
  
  geom_point(aes(x=modFledge_elasticity$coefficients[2], y=sumFledge_e$adj.r.squared), color="purple")+ #add fledge rate
  annotate("text",x=modFledge_elasticity$coefficients[2], y=sumFledge_e$adj.r.squared+.03, label="Fledge Rate", size=6, color="purple" )+
  geom_vline(xintercept = 0, linetype="dashed")+
  
  theme_classic(base_size = 20)+
  theme(axis.title.y=element_text(angle=0, vjust=0.5))

jpeg(filename = "Elasticity Plot.jpeg", 
     width=800, height=500)
ElasticityPlot
dev.off()
...
M <- cor(PopData[,-c(1,8)], use="pairwise.complete.obs")
colnames(M) <- c("1-year-old renests", "Older renests", "1-year-old clutch size", "Older clutch size", "Hatch rate", "Fledge rate", "1-year-old return", "Older return")
rownames(M) <- c("1-year-old renests", "Older renests", "1-year-old clutch size", "Older clutch size", "Hatch rate", "Fledge rate", "1-year-old return", "Older return")

CorMatrix <- corrplot(M, method = "circle", type="lower", order="alphabet", col=brewer.pal(n = 8, name = "RdYlBu"), tl.col = "black", tl.srt = 45)


jpeg(filename = "Correlation Matrix Plot.jpeg", 
     width=500, height=500)
corrplot(M, method = "circle", type="lower", order="alphabet", col=brewer.pal(n = 8, name = "RdYlBu"), tl.col = "black", tl.srt = 45)
...
SensitivityPlot2 <- ggplot(SensitivityAnalysis, aes(x=Sensitivity, y=R2_S))+
  ...
  geom_label_repel(data=SensitivityAnalysis %>% filter(Sensitivity>0.5), aes(label=Label), size=10, min.segment.length = 0, box.padding = 0.5)+
  geom_label_repel(data=SensitivityAnalysis %>% filter(Sensitivity<0.5), aes(label=Label), size=10, min.segment.length = 0, box.padding = 0.5)+
  geom_vline(xintercept = 0, linetype="dashed")+
  theme_classic(base_size = 20)+
  theme(axis.title.y=element_text(angle=0, vjust=0.5))
...
ElasticityPlot2 <- ggplot(SensitivityAnalysis, aes(x=Elasticity, y=R2_E))+
  ...
  ylab(expression(paste("Adjusted R"^ 2)))+
  geom_point(size=3, aes(shape=Location))+ 
  geom_label_repel(data=SensitivityAnalysis  ,aes(label=Label), size=10, min.segment.length = 0,  box.padding = .8)+
  geom_vline(xintercept = 0, linetype="dashed")+
  theme_classic(base_size = 20)+
  theme(axis.title.y=element_text(angle=0, vjust=0.5))
...
#let's put the plots together and save them
library(cowplot)
SensivityAnalysisPlot <- plot_grid(SensitivityPlot2, ElasticityPlot2, align="v",nrow=2, ncol=1, labels=c("A", "B"))


jpeg(filename = "Sensitivity and Elasticity Plot 2.jpeg", 
     width=600, height=800)
SensivityAnalysisPlot
dev.off()
